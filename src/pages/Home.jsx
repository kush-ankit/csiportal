        ...
        <div name='Home' className=' md:p-10 md:h-screen w-screen'>
            <div name="Home" className='h-screen w-full overflow-y-scroll no-scrollbar  rounded-lg'>
                <div className=' bg-opacity-60 w-full h-full overflow-hidden duration-300 '>
                    <div className='w-full h-full md:p-10 p-5 flex justify-center items-center'>
                        <div className='w-full h-full flex items-center'>
                            <div className='md:w-[80%] w-full h-[80%] rounded-lg'>
                                <div className='h-full w-full md:p-10'>
                                    <div className='h-full w-full'>
                                        <h1 className='md:text-5xl text-4xl font-semibold italic font-Heading md:pb-4 pb-2'>Computer Society of India</h1>
                                        <p className=' py-5 text-md'>The Computer Society of India (CSI) is a non-profit voluntary organization established in 1965. It is the largest, professional and non-governmental organization in India which works in the field of Information Technology (IT). It was established with the aim of advancing the knowledge and practice of Computer Science and related subjects. It has more than 100,000 members, including professionals, educators and students, drawn from industry, academia and research organizations. The society provides a platform for IT professionals to share their knowledge and experience and to keep abreast of the latest trends in the industry.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div className='w-full md:h-full items-center hidden md:flex'>
